                                        ...
                                        <div class="cart-product">
                                            ...
                                            <div class="cart-product-info">
                                                <p>
                                                    <span>1</span>
                                                    x
                                                    <a href="detalharLivro.php">East of eden</a>
                                                </p>
                                                <a href="detalharLivro.php">S, Orange</a>
											...
											<div class="single-banner">
												<div class="product-wrapper">
													<a href="#" class="single-banner-image-wrapper">
														<img alt="" src="images/<?php echo $livro->getCapaImagem();?>" alt="" width="150" height="270">
													</a>
												...
												<div class="banner-bottom text-center">
													<div class="banner-bottom-title">
														<a href="detalharLivro.php?livro=<?php echo $livro->getId();?>"><?php echo $livro->getTitulo();?></a>
